...
void loadTexturePNG(unsigned int* textureID, std::string path, int glTexture);
void loadTextureJPG(unsigned int* textureID, std::string path, int glTexture);
...
int main(int argc, char* argv[]) {
    ...
    loadTexturePNG(&diffuseMap, "assets/container2.png",GL_TEXTURE0);

    //箱子反光遮罩
    unsigned int specularMap;
    loadTexturePNG(&specularMap, "assets/container2_specular.png", GL_TEXTURE1);

    //很多字母(matrix)的灯条
    unsigned int matrixLight;
    loadTextureJPG(&matrixLight, "assets/matrix.jpg", GL_TEXTURE2);
    ...
    Shader ourShader("./assets/model-test-vs.glsl", "./assets/model-test-fs.glsl");
